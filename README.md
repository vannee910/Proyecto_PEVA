...
- Generación de reportes Excel listos para supervisión
- Dashboard interactivo con visualizaciones
- Implementación de fórmulas regulatorias mexicanas
...
```r
# Clonar repositorio
git clone https://github.com/vannee910/Proyecto_PEVA.git
